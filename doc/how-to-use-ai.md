# How to Use AI Engineering Workflow (.ai)

Welcome to the **AI Engineering Workflow**! This workspace uses an autonomous, multi-stack development pipeline that takes your Product Requirements Document (PRD), conducts an interactive Q&A discovery, scaffolds your custom setup, and automatically builds, tests, and validates your SaaS application.
